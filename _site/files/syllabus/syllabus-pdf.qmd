...
coursecode: "ECON 452 Fall 2022"
section: 1
author: Dr. Ryan Safner
semester: "[thoughtF22.classes.ryansafner.com](http://thoughtF22.classes.ryansafner.com)"

email: "safner@hood.edu"
web: "ryansafner.com"
officehours: "<i class='fas fa-video'></i> MW 1:30 PM—2:30 PM & by appt"
office: "Rosenstock 114"
classroom: "Rosenstock 216"
classhours: "TuTh 2:00—3:25 PM"
...
> [--- Quoted ironically in James M. Buchanan, 1964, "What Should Economists Do?"]{style="float:right"}
...
You are expected to come to class except due to medical reasons or other legitimate conflicts. Watching videos are not a substitute for attending class.[^1] Please see the [attendance policy](#attendance) for more.

[^1]: On average, even for students who complete all assignments, those that do not regularly attend class suffer by a full letter grade, ([Levitt 1993](https://www.aeaweb.org/articles?id=10.1257/jep.7.3.167)).
...
Your final course grade is the weighted average of the following assignments. You can find general descriptions for all the assignments on the [assignments page](https://thoughtF22.classes.ryansafner.com/assignments/) and more specific information and examples on each assignment's page on the [schedule page](https://thoughtF22.classes.ryansafner.com/schedule/).
...
**You can find a full schedule** with much more details, including the readings, appendices, and other further resources for each class meeting on the [schedule page](https://thoughtF22.classes.ryansafner.com/schedule/).
