...
You can find all course materials at my **dedicated website** for this course: [thoughtF21.classes.ryansafner.com](https://thoughtF21.classes.ryansafner.com). Links to the website are posted on our Blackboard course page. Please familiarize yourself with the website, see that it contains this [syllabus](https://thoughtF21.classes.ryansafner.com/syllabus/), [resources](https://thoughtF21.classes.ryansafner.com/resources/) to help you, and our [schedule](https://thoughtF21.classes.ryansafner.com/schedule/). On the schedule page, you can find each module with its own class page (**start there!**) along with all related readings, lecture slides, practice problems, and assignments.
